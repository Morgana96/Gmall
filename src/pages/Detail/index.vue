            ...
            <div class="chooseArea">
              ...
              <dl v-for="spuAttr in spuSaleAttrList" :key="spuAttr.id">
                ...
                <dd         
                  ...
                  v-for="color in spuAttr.spuSaleAttrValueList"
                  :key="color.id"
                  @click="changeactive(color,spuAttr.spuSaleAttrValueList)"
                >
...
export default {
  ...
  methods: {
    ...
    async addCart(){
      ...
      try{ 
        await this.$store.dispatch('AddCart',{skuId:this.$route.params.skuid, skuNum:this.skuNum})
